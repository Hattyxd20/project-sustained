  ...
  return (
    <div className="py-10 px-5 lg:px-10 relative">
      <div className="container mx-auto">
        <h1 className="text-base text-center mt-5">Organized by School of Engineering and Technology, MRIIRS<br /> In Association with Sustainable Development Activities  Committee - IEEE India Council</h1>
